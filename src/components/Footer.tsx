    ...
    <footer className="bg-secondary py-8 mt-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-muted-foreground max-w-xs">
              Find your beat, connect your tribe. Discover the perfect nightlife venues based on your music taste.
            </p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div className="mb-4">
              <h3 className="text-foreground font-medium mb-2">About</h3>
              <ul className="space-y-2">
                <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Our Story</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">For Venues</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Careers</a></li>
              </ul>
            </div>
            
            <div className="mb-4">
              <h3 className="text-foreground font-medium mb-2">Support</h3>
              <ul className="space-y-2">
        ...
        <div className="border-t border-border mt-8 pt-6 text-sm text-muted-foreground text-center">
          <p>© 2025 VibeVerse. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
