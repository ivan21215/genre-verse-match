...
const ProfileSetup = () => {
  const popularGenres = [
    "Electronic", "Hip Hop", "Rock", "Pop", "Jazz", "R&B", "Techno", "House"
  ];
    ...
    <div className="bg-secondary p-6 rounded-xl shadow-lg">
      <div className="flex items-center mb-6">
        ...
        <div className="ml-4">
          ...
          <p className="text-muted-foreground">Select your favorite music genres</p>
        </div>
      </div>
      ...
      <div className="mb-6">
        <Button className="w-full">
          <svg className="mr-2 h-4 w-4" viewBox="0 0 168 168" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="text-center text-sm text-muted-foreground">
        Connecting helps us personalize your experience based on your music taste
      </div>
    </div>
  );
};
