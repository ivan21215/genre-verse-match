...
import { Music, Disc, Headphones, Radio, Microphone, Guitar } from "lucide-react";
      ...
      <div className="container mx-auto pt-24 pb-12 px-4 flex-grow">
        ...
        <div className="mb-6 overflow-x-auto pb-2">
          <ToggleGroup type="single" value={selectedGenre} onValueChange={(value) => value && handleGenreChange(value)} className="flex space-x-2">
            ...
            <ToggleGroupItem value="Rap" className="whitespace-nowrap bg-orange-500 data-[state=on]:bg-orange-500/70"><Microphone className="mr-1" /> Rap</ToggleGroupItem>
